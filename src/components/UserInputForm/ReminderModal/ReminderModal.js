        ...
        if (!this.props.editMode) {
            return (
                <div className="modal_container">
                    ...
                    <div style={{ color: 'red' }}>{assetTitle}</div>
                    <div className="asset-category">Category:</div>
                    <div style={{ color: 'red' }}>{categoryTitle}</div>
                    ...
                    <div className="reminder-form-button">
                        <RaisedButton label="Submit New Reminder" primary={false} style={style} buttonStyle={style} onClick={() => this.submitReminder({ props: this.props, date: this.state.date })} />
                    </div>
                </div>
            )
        } else {
