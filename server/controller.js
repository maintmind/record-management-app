...
module.exports = {
    ...
    addReminder: (req, res) => {
        const dbInstance = req.app.get('db');
        const { cat_id, status, date_due, title, description } = req.body;
        dbInstance.reminders.addNewReminder(req.params.user_id, cat_id, status, date_due, title, description)
